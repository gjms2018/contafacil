...
<footer class="dash-footer">
    <div class="footer-wrapper">
        <div class="py-1">
            <span class="text-muted">  <?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright HELLOSOFT')); ?> <?php echo e(date('Y')); ?></span>
        </div>
...
<?php /**PATH C:\laragon\www\contafacil\resources\views/partials/admin/footer.blade.php ENDPATH**/ ?>