                        ...
                        <div data-v-363339a0="" class="d" style="width:710px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-363339a0="" class="d-inner">
                                <div data-v-363339a0="" class="row">
                                    <div data-v-363339a0="" class="col-2"><h1 data-v-363339a0="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('BILL')}}</h1>
                                        ...
                                        <div data-v-363339a0="" class="">
                                            <table data-v-363339a0="" class="summary-table">
                                                ...
                                                <tr data-v-363339a0="">
                                                    ...
                                                    <td data-v-363339a0="" class="text-right">{{Utility::billNumberFormat($settings,$bill->bill_id)}}</td>
                                                </tr>
                                                <tr data-v-363339a0="">
                                                    <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Issue Date')}}:</td>
                                                    <td data-v-363339a0="" class="text-right">{{Utility::dateFormat($settings,$bill->bill_date)}}</td>
                                                </tr>
                                                <tr data-v-363339a0="">
                                                    <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Due Date')}}:</td>
                                                    <td data-v-363339a0="" class="text-right">{{Utility::dateFormat($settings,$bill->due_date)}}</td>
                                                </tr>
