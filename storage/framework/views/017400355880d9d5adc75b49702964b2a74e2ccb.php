...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create allowance option')): ?>
            <a href="#" data-url="<?php echo e(route('allowanceoption.create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New Allowance Option')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>"  class="btn btn-sm btn-primary">
                                    ...
                                    <td>
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit allowance option')): ?>
                                            <div class="action-btn bg-primary ms-2">
                                                <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="<?php echo e(URL::to('allowanceoption/'.$allowanceoption->id.'/edit')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Edit Document Type')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\contafacil\resources\views/allowanceoption/index.blade.php ENDPATH**/ ?>