<?php echo e(Form::model($revenue, array('route' => array('revenue.update', $revenue->id), 'method' => 'PUT','enctype' => 'multipart/form-data'))); ?>
...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <img id="image" src="<?php echo e(asset(Storage::url('uploads/revenue')).'/'.$revenue->add_receipt); ?>" class="mt-2" style="width:25%;"/>
        </div>
...
<?php /**PATH C:\laragon\www\contafacil\resources\views/revenue/edit.blade.php ENDPATH**/ ?>