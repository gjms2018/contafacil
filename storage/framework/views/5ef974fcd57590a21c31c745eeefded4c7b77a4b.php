                    ...
                    <div class="table-responsive">
                        <table class="table mb-0" data-repeater-list="accounts" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    <div class="form-group">
                                        <?php echo e(Form::select('account', $accounts,'', array('class' => 'form-control select','id'=>'choices-multiple1','required'=>'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\contafacil\resources\views/journalEntry/edit.blade.php ENDPATH**/ ?>