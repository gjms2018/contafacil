                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (purchaseItems != null) {
                                ...
                                $(el.parent().parent().find('.quantity')).val(purchaseItems.quantity);
                                $(el.parent().parent().find('.price')).val(purchaseItems.price);
                                $(el.parent().parent().find('.discount')).val(purchaseItems.discount);
                            } else {
