...
<head>
    ...
    <title><?php echo e(__('HELLOSOFT SaaS')); ?></title>
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-sm-5">
                ...
                <h2
                    ...
                    data-wow-delay="0.4s"
                >
                    <?php echo e(__('ERP empresarial todo en uno con proyecto, cuenta, HRM, CRM')); ?>

                </h2>
                <p class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.6s">
                Use estos increíbles formularios para iniciar sesión o crear una nueva cuenta en su
                    proyecto gratis.
                </p>
                <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                    ...
                    >
                    <a href="https://hellosoft.net/item/helloerp-saas-all-in-one-business-erp-with-project-account-hrm-crm/33263426" class="btn btn-outline-light" target="_blank"
...
Use estos increíbles formularios para iniciar sesión o crear una nueva cuenta en su
                ...
                <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                    <a href="#" class="btn btn-primary" target="_blank"
                    ><i class="fas fa-shopping-cart me-2"></i>Comprar ahora</a
                    >
                </div>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row align-items-center justify-content-start">
            ...
            <div class="col-sm-4">
                ...
                <h2 class="mb-sm-4 wow animate__fadeInRight" data-wow-delay="0.4s">
                    <?php echo e(__('Todo en uno Business ERP con proyecto, cuenta, HRM, CRM')); ?>
                ...
                <div class="accordion accordion-flush" id="accordionExample">
                      ...
                      order?
                        ...
                        >
                            <div class="accordion-body">
                                <strong>Este es el cuerpo de acordeón del primer elemento.</strong> It
                                se muestra de forma predeterminada, hasta que el complemento de colapso agrega el
                                clases apropiadas que usamos para darle estilo a cada elemento. Estas
                                clases controlan la apariencia general, así como el
                                mostrando y ocultando a través de transiciones CSS. Puedes modificar cualquier
                                de esto con CSS personalizado o anulando nuestras variables predeterminadas.
                                También vale la pena señalar que casi cualquier HTML puede ir
                                dentro del <code>.accordion-body</code>, aunque el
                                la transición limita el desbordamiento.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item card">
                      ...
                      order?
                        ...
                        >
                            <div class="accordion-body">
                                ...
                                Está oculto de forma predeterminada, hasta que el complemento de colapso agrega el
                                clases apropiadas que usamos para darle estilo a cada elemento. Estas
                                clases controlan la apariencia general, así como el
                                mostrando y ocultando a través de transiciones CSS. Puedes modificar cualquier
                                de esto con CSS personalizado o anulando nuestras variables predeterminadas.
                    ...
                    <span class="d-flex align-items-center">
                      ...
                      order?
                        ...
                        >
                            <div class="accordion-body">
                                <strong>Este es el cuerpo del acordeón del tercer elemento.</strong> It
                                está oculto de forma predeterminada, hasta que el complemento de colapso agrega el
                                clases apropiadas que usamos para darle estilo a cada elemento. Estas
                                clases controlan la apariencia general, así como el
                                mostrando y ocultando a través de transiciones CSS. Puedes modificar cualquier
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 text-end">
                ...
                <p class="text-body">Copyright © 2022 | Design By HELLOSOFT</p>
            </div>
        </div>
    </div>
</section>
...
<?php /**PATH C:\laragon\www\contafacil\resources\views/layouts/landing.blade.php ENDPATH**/ ?>