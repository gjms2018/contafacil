                                ...
                                <div data-v-37eeda86="" class="col-33">
                                    ...
                                    <table data-v-37eeda86="" class="summary-table">
                                        ...
                                        <tr data-v-37eeda86="">
                                            ...
                                            <td data-v-37eeda86="" class="text-right">{{Utility::billNumberFormat($settings,$bill->bill_id)}}</td>
                                        </tr>
                                        <tr data-v-37eeda86="">
                                            <td data-v-37eeda86="" class="tu">{{__('Issue Date')}}:</td>
                                            <td data-v-37eeda86=""
                                                class="text-right">{{Utility::dateFormat($settings,$bill->bill_date)}}</td>
                                        </tr>
                                        <tr data-v-37eeda86="">
                                            <td data-v-37eeda86="" class="tu">{{__('Due Date')}}:</td>
                                            <td data-v-37eeda86="" class="text-right">{{Utility::dateFormat($settings,$bill->due_date)}}</td>
                                        </tr>
