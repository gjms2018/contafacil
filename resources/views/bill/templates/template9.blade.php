                            ...
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-2"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('BILL')}}</h1>
                                        <h3 data-v-7d9d14b5="">{{Utility::billNumberFormat($settings,$bill->bill_id)}}</h3>
                                        <p data-v-7d9d14b5="">{{Utility::dateFormat($settings,$bill->bill_date)}}</p>
                                    </div>
                                    ...
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <table data-v-7d9d14b5="" class="summary-table">
                                            ...
                                            <tr data-v-7d9d14b5="">
                                                ...
                                                <td data-v-7d9d14b5="" class="text-right">{{Utility::dateFormat($settings,$bill->due_date)}}</td>
                                            </tr>
