                ...
                <div class="col-xl-6 img-card-side">
                    <div class="auth-img-content">
                        ...
                        <h3 class="text-white mb-4 mt-5">
                            “Atención es la nueva moneda”
                        </h3>
                        <p class="text-white">
                        Cuanto más fácil se vea la escritura, más esfuerzo puso el escritor en el proceso.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="auth-footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-6">
                        <p class="">
                            <?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright HELLOSOFT')); ?> <?php echo e(date('Y')); ?>
...
<?php /**PATH C:\laragon\www\contafacil\resources\views/layouts/auth.blade.php ENDPATH**/ ?>